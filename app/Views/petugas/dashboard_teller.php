...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Kelola antrian transaksi teller dan kasir</p>
        </div>
    ...
    <div class="row">
                ...
                <div class="card-header bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">
                            ...
                            Antrian Teller Aktif
                        </h5>
                        <div class="d-flex align-items-center">
                            <span class="badge bg-success fs-6 me-2"><?= count($antrian_aktif) ?> Antrian</span>
                                        ...
                                        <tr class="antrian-row">
                                            <td class="px-4 py-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <small class="text-muted d-block">Teller</small>
                                                        <small class="text-success fw-bold">#<?= $index + 1 ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-4 py-3">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-success btn-sm" onclick="panggilAntrian(<?= $antrian['id'] ?>)">
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            <div class="empty-state">
                                ...
                                <p class="text-muted">Semua antrian teller telah dilayani</p>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="d-grid gap-2">
                        <button class="btn btn-outline-success" onclick="panggilBerikutnya()">
                            <i class="fas fa-forward mr-2"></i>
                            Panggil Berikutnya
                        </button>
                        <button class="btn btn-outline-info" onclick="lihatLaporanTeller()">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <h6 class="card-title text-muted mb-3">Info Teller</h6>
                    <div class="space-y-3">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold">Teller 1</span>
                        </div>
                        <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold">50 transaksi/hari</span>
                        </div>
                    </div>
                </div>
            </div>
...
function selesaiAntrian(antrianId) {
    Swal.fire({
        title: 'Konfirmasi',
        text: 'Tandai transaksi ini selesai?',
        icon: 'question',
...
function lihatLaporanTeller() {
    Swal.fire({
        icon: 'info',
        title: 'Info',
        text: 'Fitur laporan teller akan segera tersedia'
    });
}
