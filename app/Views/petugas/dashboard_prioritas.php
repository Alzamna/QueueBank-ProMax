...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Kelola antrian layanan prioritas dan VIP</p>
        </div>
    ...
    <div class="alert alert-warning border-0 shadow-sm mb-4">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h6 class="alert-heading mb-1">Layanan Prioritas</h6>
                <p class="mb-0">Antrian prioritas akan dilayani terlebih dahulu dengan estimasi waktu yang lebih cepat</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
                ...
                <div class="card-header bg-white border-0 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">
                            ...
                            Antrian Prioritas Aktif
                        </h5>
                        <div class="d-flex align-items-center">
                            <span class="badge bg-warning text-dark fs-6 me-2"><?= count($antrian_aktif) ?> Antrian</span>
                            <button class="btn btn-outline-warning btn-sm" onclick="refreshAntrian()">
                            ...
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php foreach($antrian_aktif as $index => $antrian): ?>
                                        <tr class="antrian-row priority-row">
                                            <td class="px-4 py-3">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-warning fw-bold">#<?= $index + 1 ?></small>
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-warning btn-sm" onclick="panggilAntrian(<?= $antrian['id'] ?>)">
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            <div class="empty-state">
                                ...
                                <h6 class="text-muted">Tidak ada antrian prioritas aktif</h6>
                                <p class="text-muted">Semua antrian prioritas telah dilayani</p>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <div class="d-grid gap-2">
                        <button class="btn btn-outline-warning" onclick="panggilBerikutnya()">
                            <i class="fas fa-forward mr-2"></i>
                            Panggil Berikutnya
                        </button>
                        <button class="btn btn-outline-info" onclick="lihatLaporanPrioritas()">
                            <i class="fas fa-chart-bar mr-2"></i>
                            Laporan Prioritas
                        </button>
                        <button class="btn btn-outline-success" onclick="setPriorityLevel()">
            ...
            <!-- Info Layanan Prioritas -->
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <h6 class="card-title text-muted mb-3">Info Layanan Prioritas</h6>
                    <div class="space-y-3">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold">Prioritas 1</span>
                        </div>
                        <div class="d-flex justify-content-between">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold">20 layanan/hari</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted">Estimasi:</span>
                            <span class="fw-bold">3-5 menit</span>
                        </div>
                    </div>
                </div>
            </div>
...
function lihatLaporanPrioritas() {
    Swal.fire({
        icon: 'info',
        title: 'Info',
        text: 'Fitur laporan prioritas akan segera tersedia'
    });
}
...
function setPriorityLevel() {
    Swal.fire({
        icon: 'info',
        title: 'Info',
        text: 'Fitur set level prioritas akan segera tersedia'
    });
}
